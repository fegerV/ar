...
|--------|----------|------|--------|
| main.py | ~55% | > 70% | 🟡 Требуется усиление |
| auth.py | ~82% | > 80% | ✅ На цели |
| database.py | ~74% | > 90% | 🟡 Добавить unit-тесты |
| file_validator.py | ~68% | > 80% | 🟡 Запланировано расширение |
| nft_marker_generator.py | ~58% | > 70% | 🟡 Производственные сценарии |
| storage.py | ~66% | > 80% | 🟡 Нужны edge-case тесты |
| **Overall** | **~60%** | **> 70%** | **🟡 В работе** |
