# Vertex-Art-AR Упрощенное развертывание

## Обзор

Этот документ описывает упрощенный подход к развертыванию Vertex-Art-AR, основанный на подходах из проекта Stogram. Основная цель - упростить развертывание и уменьшить количество зависимостей.
...
Если вы переходите с оригинальной версии Vertex-Art-AR, используйте следующий подход:
...
Упрощенная версия Vertex-Art-AR сохраняет все основные функции:
