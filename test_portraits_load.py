        ...
        try:
            for i in range(count):
                ...
                self.test_files.append(
                    {"image": img_path, "video": video_path, "name": f"Тестовый Клиент {i+1}", "phone": f"+7999123456{i:02d}"}
                )
    ...
    def test_api_endpoints(self, num_requests: int = 100) -> LoadTestMetrics:
        ...
        def make_request(endpoint_info):
            ...
            try:
                ...
                return {"success": False, "response_time": time.time() - request_start, "error": str(e), "endpoint": endpoint}
        ...
        def continuous_requests():
            ...
            while time.time() < end_time:
                ...
                try:
                    ...
                    endpoints = ["/clients/list", "/portraits/list", "/admin/system-info"]
                    ...
                    results.append({"success": False, "response_time": time.time() - request_start, "error": str(e)})
