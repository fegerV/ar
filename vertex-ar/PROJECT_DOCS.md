# Vertex AR - Документация проекта (Упрощенная версия)

## Общее описание

Vertex AR - это упрощенное веб-приложение для создания и управления AR-контентом. Проект включает в себя веб-интерфейс, систему аутентификации, локальное хранилище файлов и AR-функциональность. Основан на подходах из проекта Stogram для упрощения развертывания и обслуживания.
