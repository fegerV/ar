...
class MinioStorageAdapter(StorageAdapter):
    ...
    def __init__(self, endpoint: str, access_key: str, secret_key: str, bucket: str):
        ...
        try:
            ...
            self.client = Minio(endpoint, access_key=access_key, secret_key=secret_key, secure=False)  # Set to True for HTTPS
    ...
    async def save_file(self, file_data: bytes, file_path: str) -> str:
        ...
        try:
            self.client.put_object(self.bucket, file_path, BytesIO(file_data), length=len(file_data))
