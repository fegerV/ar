...
class NotificationHandler:
    ...
    def send_login_notification(username: str, success: bool, current_user: Optional[str] = None):
        ...
        NotificationHandler._send_notification(
            title=title, message=message, user_id=current_user or username, notification_type=notification_type
        )

    @staticmethod
    def send_upload_notification(
        user: str, record_id: Optional[str] = None, success: bool = True, error_message: Optional[str] = None
    ):
        ...
        NotificationHandler._send_notification(title=title, message=message, user_id=user, notification_type=notification_type)
    ...
    @staticmethod
    def send_file_access_notification(
        filename: str, user_id: Optional[str] = None, notification_type: str = "error", action: str = "получения"
    ):
    ...
    def send_ar_page_notification(record_id: str, user_id: Optional[str] = None):
        ...
        NotificationHandler._send_notification(title=title, message=message, user_id=user_id, notification_type="error")
    ...
    def _send_notification(title: str, message: str, user_id: Optional[str] = None, notification_type: str = "info"):
        ...
        try:
            original_send_notification(title=title, message=message, user_id=user_id, notification_type=notification_type)
