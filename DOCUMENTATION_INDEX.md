...
1. [README.md](./README.md) - что такое Vertex AR
2. *(Скоро)* USER_GUIDE.md - как использовать систему
3. [API_DOCUMENTATION.md](./API_DOCUMENTATION.md) - примеры использования API
...
| Документ | Описание | Аудитория | Статус |
|----------|----------|-----------|--------|
| USER_GUIDE.md | Руководство пользователя | Пользователи | ⏳ Планируется |
