...
class PerformanceMonitor:
    ...
    def get_summary(self) -> Dict:
        ...
        summary = {
            ...
            "cpu": {"max": max(cpu_values), "min": min(cpu_values), "avg": sum(cpu_values) / len(cpu_values)},
            "memory": {
    ...
    def test_large_file_performance(self):
        ...
        try:
            ...
            with open(large_image, "rb") as img, open(large_video, "rb") as vid:
                files = {"image": ("large_image.jpg", img, "image/jpeg"), "video": ("large_video.mp4", vid, "video/mp4")}
