        ...
        try:
            ...
            for i, client in enumerate(test_clients):
                ...
                with open(img_path, 'rb') as img, open(video_path, 'rb') as vid:
                    files = {
                        'image': (f"portrait_{i}.jpg", img, 'image/jpeg'),
                        'video': (f"video_{i}.mp4", vid, 'video/mp4')
                    }
                    data = {
                        'phone': client['phone'],
                        'name': client['name']
            ...
            result = TestResult(
                ...
                duration=duration,
                details={
                    'clients_created': len(test_clients),
            ...
            if response.status_code == 200:
                ...
                result = TestResult(
                    ...
                    details={
                        ...
                        'expected_min': len(self.test_data['clients'])
                    }
                )
            ...
            if response.status_code == 200:
                ...
                result = TestResult(
                    ...
                    details={
                        ...
                        'expected_min': len(self.test_data['orders'])
                    }
                )
        ...
        try:
            ...
            result = TestResult(
                ...
                details={
                    ...
                    'activated_video_id': inactive_video['id']
                }
            )
