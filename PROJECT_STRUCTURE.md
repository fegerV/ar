...
**После очистки:** cleanup-remove-unused-files-update-docs
...
│   ├── test_user_management.py          # Тесты управления пользователями
│   └── ...
│
...
### Тестирование
- **Unit тесты:** `vertex-ar/tests/`
- **Интеграционные:** `tests/`
- **Производительность:** `scripts/run_performance_tests.sh`
- **Готовность:** `scripts/check_production_readiness.sh`
